...
def after_scenario(context, scenario):
    ...
    try:
        ...
        if 'sriov' in scenario.tags:
            ...
            call("echo 0 > /sys/class/net/eno2/device/sriov_numvfs", shell=True)
            call("echo 0 > /sys/class/net/enp66s0f0/device/sriov_numvfs", shell=True)
            ...
            call("set 1 to /sys/class/net/enp66s0f0/device/sriov_drivers_autoprobe", shell=True)
            call("echo 1 > /sys/class/net/enp66s0f0/device/sriov_drivers_autoprobe", shell=True)
            call("echo 1 > /sys/class/net/eno2/device/sriov_drivers_autoprobe", shell=True)
